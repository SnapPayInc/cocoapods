...
#ifndef SNAPLIISDK_SWIFT_H
#define SNAPLIISDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SnapliiSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SnapliiSDK18AcuantProgressView")
@interface AcuantProgressView : UIView
@property (nonatomic) BOOL shouldSetupConstraints;
@property (nonatomic, strong) UIView * _Null_unspecified loadingView;
@property (nonatomic, strong) UILabel * _Null_unspecified messageView;
@property (nonatomic, strong) UIActivityIndicatorView * _Null_unspecified activityIndicator;
- (nonnull instancetype)initWithFrame:(CGRect)frame center:(CGPoint)center OBJC_DESIGNATED_INITIALIZER;
- (void)startAnimation;
- (void)stopAnimation;
...
SWIFT_CLASS("_TtC10SnapliiSDK28FaceLivenessCameraController")
@interface FaceLivenessCameraController : UIViewController <AcuantHGLiveFaceCaptureDelegate>
@property (nonatomic, copy) void (^ _Nullable passSelfie)(UIImage * _Nonnull);
@property (nonatomic, weak) id <HGLivenessDelegate> _Nullable delegate;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC10SnapliiSDK13SNEnvironment")
@interface SNEnvironment : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@property (nonatomic, readonly, copy) NSString * _Nonnull name;
@property (nonatomic, readonly, copy) NSString * _Nonnull host;
@property (nonatomic, readonly, copy) NSString * _Nonnull h5Host;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull Stage;)
+ (NSString * _Nonnull)Stage SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull Shaolin;)
+ (NSString * _Nonnull)Shaolin SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull Sandbox;)
+ (NSString * _Nonnull)Sandbox SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull Release;)
+ (NSString * _Nonnull)Release SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface UIWindow (SWIFT_EXTENSION(SnapliiSDK))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UIWindow * _Nullable key;)
+ (UIWindow * _Nullable)key SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UIWindow * _Nonnull main;)
+ (UIWindow * _Nonnull)main SWIFT_WARN_UNUSED_RESULT;
@end
