#
#  Be sure to run `pod spec lint SnapliiSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  This is SnapliiSDK. This is SnapliiSDK.
                   DESC

  spec.homepage     = "https://github.com/SnapPayInc/cocoapods.git"
  ...
  spec.source       = { :git => "https://github.com/SnapPayInc/cocoapods.git", :tag => "#{spec.version}" }
